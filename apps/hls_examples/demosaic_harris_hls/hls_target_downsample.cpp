...
#pragma HLS ARRAY_PARTITION variable=_downsample_2_stencil.value complete dim=0
   ...
   uint8_t _130 = _padded_2_stencil(0, 2);
   uint8_t _131 = _padded_2_stencil(2, 2);
   uint8_t _132 = _padded_2_stencil(2, 0);
   uint8_t _133 = _padded_2_stencil(0, 0);
   uint16_t _134 = (uint16_t)(_133);
   uint16_t _135 = (uint16_t)(_132);
   uint16_t _136 = _134 + _135;
   uint16_t _137 = (uint16_t)(_130);
   uint16_t _138 = _136 + _137;
   uint16_t _139 = (uint16_t)(_131);
   uint16_t _140 = _138 + _139;
   uint16_t _141 = _140 >> 2;
   uint8_t _142 = (uint8_t)(_141);
   uint16_t _143 = (uint16_t)(_142);
   uint16_t _144 = _135 + _139;
   uint16_t _145 = _144 >> 1;
   uint8_t _146 = (uint8_t)(_145);
   uint16_t _147 = (uint16_t)(_146);
   uint16_t _148 = _143 + _147;
   uint16_t _149 = _148 >> 1;
   uint8_t _150 = (uint8_t)(_149);
   uint16_t _151 = (uint16_t)(_150);
   uint16_t _152 = _137 + _139;
   uint16_t _153 = _152 >> 1;
   uint8_t _154 = (uint8_t)(_153);
   uint16_t _155 = (uint16_t)(_154);
   uint16_t _156 = _155 + _139;
   uint16_t _157 = _156 >> 1;
   uint8_t _158 = (uint8_t)(_157);
   uint16_t _159 = (uint16_t)(_158);
   uint16_t _160 = _151 + _159;
   uint16_t _161 = _160 >> 1;
   uint8_t _162 = (uint8_t)(_161);
   _downsample_2_stencil(0, 0, 0) = _162;
   uint8_t _163 = _padded_2_stencil(2, 1);
   uint8_t _164 = _padded_2_stencil(1, 2);
   uint8_t _165 = _padded_2_stencil(0, 1);
   uint16_t _166 = (uint16_t)(_165);
   uint16_t _167 = (uint16_t)(_163);
   uint16_t _168 = _166 + _167;
   uint8_t _169 = _padded_2_stencil(1, 0);
   uint16_t _170 = (uint16_t)(_169);
   uint16_t _171 = _168 + _170;
   uint16_t _172 = (uint16_t)(_164);
   uint16_t _173 = _171 + _172;
   uint16_t _174 = _173 >> 2;
   uint8_t _175 = (uint8_t)(_174);
   uint16_t _176 = (uint16_t)(_175);
   uint16_t _177 = _176 + _167;
   uint16_t _178 = _177 >> 1;
   uint8_t _179 = (uint8_t)(_178);
   uint16_t _180 = (uint16_t)(_179);
   uint8_t _181 = _padded_2_stencil(3, 2);
   uint16_t _182 = (uint16_t)(_181);
   uint16_t _183 = _172 + _182;
   uint16_t _184 = _183 + _167;
   uint8_t _185 = _padded_2_stencil(2, 3);
   uint16_t _186 = (uint16_t)(_185);
   uint16_t _187 = _184 + _186;
   uint16_t _188 = _187 >> 2;
   uint8_t _189 = (uint8_t)(_188);
   uint16_t _190 = (uint16_t)(_189);
   uint16_t _191 = _172 + _190;
   uint16_t _192 = _191 >> 1;
   uint8_t _193 = (uint8_t)(_192);
   uint16_t _194 = (uint16_t)(_193);
   uint16_t _195 = _180 + _194;
   uint16_t _196 = _195 >> 1;
   uint8_t _197 = (uint8_t)(_196);
   _downsample_2_stencil(1, 0, 0) = _197;
   uint8_t _198 = _padded_2_stencil(1, 1);
   uint16_t _199 = (uint16_t)(_198);
   uint8_t _200 = _padded_2_stencil(3, 1);
   uint16_t _201 = (uint16_t)(_200);
   uint16_t _202 = _199 + _201;
   uint8_t _203 = _padded_2_stencil(1, 3);
   uint16_t _204 = _202 >> 1;
   uint8_t _205 = (uint8_t)(_204);
   uint16_t _206 = (uint16_t)(_205);
   uint16_t _207 = _199 + _206;
   uint16_t _208 = _207 >> 1;
   uint8_t _209 = (uint8_t)(_208);
   uint16_t _210 = (uint16_t)(_209);
   uint16_t _211 = (uint16_t)(_203);
   uint16_t _212 = _199 + _211;
   uint16_t _213 = _212 >> 1;
   uint8_t _214 = (uint8_t)(_213);
   uint16_t _215 = (uint16_t)(_214);
   uint16_t _216 = _202 + _211;
   uint8_t _217 = _padded_2_stencil(3, 3);
   uint16_t _218 = (uint16_t)(_217);
   uint16_t _219 = _216 + _218;
   uint16_t _220 = _219 >> 2;
   uint8_t _221 = (uint8_t)(_220);
   uint16_t _222 = (uint16_t)(_221);
   uint16_t _223 = _215 + _222;
   uint16_t _224 = _223 >> 1;
   uint8_t _225 = (uint8_t)(_224);
   uint16_t _226 = (uint16_t)(_225);
   uint16_t _227 = _210 + _226;
