...
int pipeline_zynq(buffer_t *_p2___input1_buffer, buffer_t *_p2___input2_buffer, buffer_t *_output__2_buffer, const int32_t __hwacc, const int32_t __cma) {
 kbuf_t input1_kbuf = {0};
 input1_kbuf.width = 1920;
 input1_kbuf.height = 1080;
 input1_kbuf.depth = 1;
 input1_kbuf.stride = 2048;
 input1_kbuf.phys_addr = _p2___input1_buffer->dev;
 kbuf_t input2_kbuf = {0};
 input2_kbuf.width = 1920;
 input2_kbuf.height = 1080;
 input2_kbuf.depth = 1;
 input2_kbuf.stride = 2048;
 input2_kbuf.phys_addr = _p2___input2_buffer->dev;
 ...
 kbuf_t _slice_padded1__2;
 halide_slice_kbuf(&input1_kbuf, &_slice_padded1__2, 201-7, 41-7, 1454, 974);
 kbuf_t _slice_padded2__2;
 halide_slice_kbuf(&input2_kbuf, &_slice_padded2__2, 201-5, 41-5, 1450, 970);
 kbuf_t _kbufs[3];
 _kbufs[0] = _slice_padded1__2;
 _kbufs[1] = _slice_padded2__2;
 _kbufs[2] = output_kbuf;
