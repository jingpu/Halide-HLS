...
#pragma HLS ARRAY_PARTITION variable=_gray_4_stencil.value complete dim=0
   ...
   uint8_t _192 = _padded2_2_stencil(2, 1);
   uint8_t _193 = _padded2_2_stencil(1, 2);
   uint8_t _194 = _padded2_2_stencil(2, 0);
   uint8_t _195 = _padded2_2_stencil(0, 2);
   uint8_t _196 = _padded2_2_stencil(2, 2);
...
#pragma HLS ARRAY_PARTITION variable=_gray_3_stencil.value complete dim=0
   ...
   uint8_t _305 = _padded1_2_stencil(2, 1);
   uint8_t _306 = _padded1_2_stencil(1, 2);
   uint8_t _307 = _padded1_2_stencil(2, 0);
   uint8_t _308 = _padded1_2_stencil(0, 2);
   uint8_t _309 = _padded1_2_stencil(2, 2);
   ...
   uint16_t _316 = _314 >> 1;
   uint8_t _317 = (uint8_t)(_316);
   uint16_t _318 = (uint16_t)(_317);
   uint16_t _319 = _311 + _318;
   uint16_t _320 = _319 >> 1;
   uint8_t _321 = (uint8_t)(_320);
   uint16_t _322 = (uint16_t)(_321);
   uint16_t _323 = (uint16_t)(_315);
   uint16_t _324 = _311 + _323;
   uint16_t _325 = _324 >> 1;
   uint8_t _326 = (uint8_t)(_325);
   uint16_t _327 = (uint16_t)(_326);
   uint16_t _328 = _314 + _323;
   uint8_t _329 = _padded1_2_stencil(3, 3);
   uint16_t _330 = (uint16_t)(_329);
   uint16_t _331 = _328 + _330;
   uint16_t _332 = _331 >> 2;
   uint8_t _333 = (uint8_t)(_332);
   uint16_t _334 = (uint16_t)(_333);
   uint16_t _335 = _327 + _334;
   uint16_t _336 = _335 >> 1;
   uint8_t _337 = (uint8_t)(_336);
   uint16_t _338 = (uint16_t)(_337);
   uint16_t _339 = _322 + _338;
   uint16_t _340 = _339 >> 1;
   uint8_t _341 = (uint8_t)(_340);
   uint16_t _342 = (uint16_t)(_341);
   uint16_t _343 = (uint16_t)(77);
   uint16_t _344 = _342 * _343;
   uint8_t _345 = _padded1_2_stencil(0, 1);
   uint16_t _346 = (uint16_t)(_345);
   uint16_t _347 = (uint16_t)(_305);
   uint16_t _348 = _346 + _347;
   uint8_t _349 = _padded1_2_stencil(1, 0);
   uint16_t _350 = (uint16_t)(_349);
   uint16_t _351 = _348 + _350;
   uint16_t _352 = (uint16_t)(_306);
   uint16_t _353 = _351 + _352;
   uint16_t _354 = _353 >> 2;
   uint8_t _355 = (uint8_t)(_354);
   uint16_t _356 = (uint16_t)(_355);
   uint16_t _357 = _356 + _347;
   uint16_t _358 = _357 >> 1;
   uint8_t _359 = (uint8_t)(_358);
   uint16_t _360 = (uint16_t)(_359);
   uint8_t _361 = _padded1_2_stencil(3, 2);
   uint16_t _362 = (uint16_t)(_361);
   uint16_t _363 = _352 + _362;
   uint16_t _364 = _363 + _347;
   uint8_t _365 = _padded1_2_stencil(2, 3);
   uint16_t _366 = (uint16_t)(_365);
   uint16_t _367 = _364 + _366;
   uint16_t _368 = _367 >> 2;
   uint8_t _369 = (uint8_t)(_368);
   uint16_t _370 = (uint16_t)(_369);
   uint16_t _371 = _352 + _370;
   uint16_t _372 = _371 >> 1;
   uint8_t _373 = (uint8_t)(_372);
   uint16_t _374 = (uint16_t)(_373);
   uint16_t _375 = _360 + _374;
   uint16_t _376 = _375 >> 1;
   uint8_t _377 = (uint8_t)(_376);
   uint16_t _378 = (uint16_t)(_377);
   uint16_t _379 = (uint16_t)(150);
   uint16_t _380 = _378 * _379;
   uint16_t _381 = _344 + _380;
   uint8_t _382 = _padded1_2_stencil(0, 0);
   uint16_t _383 = (uint16_t)(_382);
   uint16_t _384 = (uint16_t)(_307);
   uint16_t _385 = _383 + _384;
   uint16_t _386 = (uint16_t)(_308);
   uint16_t _387 = _385 + _386;
   uint16_t _388 = (uint16_t)(_309);
   uint16_t _389 = _387 + _388;
   uint16_t _390 = _389 >> 2;
   uint8_t _391 = (uint8_t)(_390);
   uint16_t _392 = (uint16_t)(_391);
   uint16_t _393 = _384 + _388;
   uint16_t _394 = _393 >> 1;
   uint8_t _395 = (uint8_t)(_394);
   uint16_t _396 = (uint16_t)(_395);
   uint16_t _397 = _392 + _396;
   uint16_t _398 = _397 >> 1;
   uint8_t _399 = (uint8_t)(_398);
   uint16_t _400 = (uint16_t)(_399);
   uint16_t _401 = _386 + _388;
   uint16_t _402 = _401 >> 1;
   uint8_t _403 = (uint8_t)(_402);
   uint16_t _404 = (uint16_t)(_403);
   uint16_t _405 = _404 + _388;
   uint16_t _406 = _405 >> 1;
   uint8_t _407 = (uint8_t)(_406);
   uint16_t _408 = (uint16_t)(_407);
   uint16_t _409 = _400 + _408;
   uint16_t _410 = _409 >> 1;
   uint8_t _411 = (uint8_t)(_410);
   uint16_t _412 = (uint16_t)(_411);
   uint16_t _413 = (uint16_t)(29);
   uint16_t _414 = _412 * _413;
   uint16_t _415 = _381 + _414;
...
#pragma HLS ARRAY_PARTITION variable=__auto_insert__hw_output_2_stencil.value complete dim=0
   ...
   int32_t _1383 = _A01_2_stencil(0, 0);
   int32_t _1384 = _A11_2_stencil(0, 0);
   int32_t _1385 = _A00_2_stencil(0, 0);
   int32_t _1386 = _1385 * _1384;
   int32_t _1387 = _1383 * _1383;
   int32_t _1388 = _1386 - _1387;
   float _1389 = (float)(_1388);
   float _1390 = float_from_bits(1065353216 /* 1 */) / _1389;
   bool _1391 = _1389 == float_from_bits(0 /* 0 */);
   float _1392 = (float)(_1391 ? float_from_bits(0 /* 0 */) : _1390);
   uint8_t _1393 = _gray_4_stencil(0, 0);
   uint8_t _1394 = _1393 >> 1;
   uint16_t _1395 = (uint16_t)(_1394);
   float _1396 = (float)(_1384);
   float _1397 = _1392 * _1396;
   int32_t _1398 = _p2_b0_stencil(0, 0);
   int32_t _1399 = 0 - _1398;
   float _1400 = (float)(_1399);
   float _1401 = _1397 * _1400;
   float _1402 = float_from_bits(0 /* 0 */) - _1392;
   float _1403 = (float)(_1383);
   float _1404 = _1402 * _1403;
   int32_t _1405 = _p2_b1_stencil(0, 0);
   int32_t _1406 = 0 - _1405;
   float _1407 = (float)(_1406);
   float _1408 = _1404 * _1407;
   float _1409 = _1401 + _1408;
   int32_t _1410 = (int32_t)(_1409);
   int32_t _1411 = 0 - _1410;
   bool _1412 = _1410 > 0;
   int32_t _1413 = (int32_t)(_1412 ? _1410 : _1411);
   uint32_t _1414 = (uint32_t)(_1413);
   uint32_t _1415 = _1414;
   uint32_t _1416 = (uint32_t)(2);
   uint32_t _1417 = _1415 * _1416;
   uint32_t _1418 = (uint32_t)(255);
   uint32_t _1419 = min(_1417, _1418);
   uint8_t _1420 = (uint8_t)(_1419);
   uint16_t _1421 = (uint16_t)(_1420);
   uint16_t _1422 = _1395 + _1421;
   uint16_t _1423 = (uint16_t)(255);
   uint16_t _1424 = min(_1422, _1423);
   uint8_t _1425 = (uint8_t)(_1424);
   __auto_insert__hw_output_2_stencil(0, 0, 0) = _1425;
   int32_t _1426 = _A00_2_stencil(0, 0);
   int32_t _1427 = _A01_2_stencil(0, 0);
   int32_t _1428 = _A11_2_stencil(0, 0);
   int32_t _1429 = _1426 * _1428;
   int32_t _1430 = _1427 * _1427;
   int32_t _1431 = _1429 - _1430;
   float _1432 = (float)(_1431);
   float _1433 = float_from_bits(1065353216 /* 1 */) / _1432;
   bool _1434 = _1432 == float_from_bits(0 /* 0 */);
   float _1435 = (float)(_1434 ? float_from_bits(0 /* 0 */) : _1433);
   uint8_t _1436 = _gray_4_stencil(0, 0);
   uint8_t _1437 = _1436 >> 1;
   uint16_t _1438 = (uint16_t)(_1437);
   float _1439 = float_from_bits(0 /* 0 */) - _1435;
   int32_t _1440 = _A10_2_stencil(0, 0);
   float _1441 = (float)(_1440);
   float _1442 = _1439 * _1441;
   int32_t _1443 = _p2_b0_stencil(0, 0);
   int32_t _1444 = 0 - _1443;
   float _1445 = (float)(_1444);
   float _1446 = _1442 * _1445;
   float _1447 = (float)(_1426);
   float _1448 = _1435 * _1447;
   int32_t _1449 = _p2_b1_stencil(0, 0);
   int32_t _1450 = 0 - _1449;
   float _1451 = (float)(_1450);
   float _1452 = _1448 * _1451;
   float _1453 = _1446 + _1452;
   int32_t _1454 = (int32_t)(_1453);
   int32_t _1455 = 0 - _1454;
   bool _1456 = _1454 > 0;
   int32_t _1457 = (int32_t)(_1456 ? _1454 : _1455);
   uint32_t _1458 = (uint32_t)(_1457);
   uint32_t _1459 = _1458;
   uint32_t _1460 = (uint32_t)(2);
   uint32_t _1461 = _1459 * _1460;
   uint32_t _1462 = (uint32_t)(255);
   uint32_t _1463 = min(_1461, _1462);
   uint8_t _1464 = (uint8_t)(_1463);
   uint16_t _1465 = (uint16_t)(_1464);
   uint16_t _1466 = _1438 + _1465;
   uint16_t _1467 = (uint16_t)(255);
   uint16_t _1468 = min(_1466, _1467);
   uint8_t _1469 = (uint8_t)(_1468);
   __auto_insert__hw_output_2_stencil(1, 0, 0) = _1469;
   uint8_t _1470 = _gray_4_stencil(0, 0);
   uint8_t _1471 = _1470 >> 1;
   __auto_insert__hw_output_2_stencil(2, 0, 0) = _1471;
