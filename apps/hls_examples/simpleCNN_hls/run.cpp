...
int main(int argc, char **argv) {
    BufferMinimal<uint8_t> in(3, 256, 256);
    BufferMinimal<uint8_t> weight(64, 3, 3, 3);
    uint8_t bias = 0;

    BufferMinimal<uint8_t> out_native(weight.width(), in.height(), in.channels());
    BufferMinimal<uint8_t> out_hls(weight.width(), in.height(), in.channels());
