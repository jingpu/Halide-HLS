#ifndef HALIDE_CODEGEN_CATAPULTHLS_BASE_H
#define HALIDE_CODEGEN_CATAPULTHLS_BASE_H

/** \file
 *
 * Defines an base class of the CatapultHLS C code-generator
 */
#include "CodeGen_C.h"
#include "Module.h"
#include "Scope.h"
 ...
 */
class CodeGen_CatapultHLS_Base : public CodeGen_C {
public:
    /** Initialize a C code generator pointing at a particular output
     * stream (e.g. a file, or std::cout) */
    CodeGen_CatapultHLS_Base(std::ostream &dest,
                     Target target,
